...
namespace RaspberryHut.Views
{
    ...
    public partial class Temperature : TabbedPage
    {
        ...
        public Temperature()
        {
            ...
            //ChartLivingroom.Chart = new BarChart();
            //ChartBathroom.Chart = new BarChart();
            //ChartBathroom.Chart.Entries = entries;
            //ChartCellar.Chart = new BarChart();
            //Chartvater.Chart = new BarChart();
