...
namespace RaspberryHut.ViewModels
{
    public class MeteostationViewModel : INotifyPropertyChanged
    {
        ...
        public MeteostationViewModel()
        {
            ...
            lastDate = _databaseService.GetLastMeteoDateAsync();
        }

        public static async Task<MeteostationViewModel> CreateAsync()
        {
            var viewModel = new MeteostationViewModel();
        ...
        public async Task LoadMeteoDataAsync()
        {
            ...
            ListMeteo.Clear();
            //ListGrafMeteo.Clear();
            var newListMeteo = new ObservableCollection<Models.Meteostation>(dataBaseData.Take(15));
            ListGrafMeteo = newListMeteo;
        ...
        public Chart TempChart
        {
            ...
            set
            {
                ...
                {
                    _tempChart = value;
                    _tempChart.AnimationDuration = TimeSpan.FromMilliseconds(200);
        ...
        public Chart HumidityChart
        {
            ...
            set
            {
                if (_humidityChart != value)
                {
                    ...
                    _humidityChart.AnimationDuration = TimeSpan.FromMilliseconds(200);
        ...
        public Chart PressureChart
        {
            ...
            set
            {
                if (_pressureChart != value)
                {
                    ...
                    _pressureChart.AnimationDuration = TimeSpan.FromMilliseconds(200);
        ...
        public Chart WindSpeedChart
        {
            ...
            set
            {
                if (_windSpeedChart != value)
                {
                    ...
                    _windSpeedChart.AnimationDuration = TimeSpan.FromMilliseconds(200);
        ...
        public Chart RainfallChart
        {
            ...
            set
            {
                if (_rainfallChart != value)
                {
                    ...
                    _rainfallChart.AnimationDuration = TimeSpan.FromMilliseconds(200);
