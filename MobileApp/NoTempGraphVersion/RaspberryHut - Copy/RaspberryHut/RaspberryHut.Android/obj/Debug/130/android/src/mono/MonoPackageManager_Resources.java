...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "RaspberryHut.Android.dll" comes first in this list. */
		"RaspberryHut.Android.dll",
		"FormsViewGroup.dll",
		"Microcharts.dll",
		...
		"Npgsql.dll",
		"OnScreenSizeMarkup.Core.dll",
		"OnScreenSizeMarkup.Forms.dll",
		"RaspberryHut.dll",
		"SkiaSharp.dll",
